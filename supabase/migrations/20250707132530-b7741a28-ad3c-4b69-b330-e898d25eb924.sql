...
BEGIN
  CASE frequency
    WHEN 'daily' THEN
      RETURN occurrence_date + (frequency_value || ' days')::INTERVAL;
    WHEN 'weekly' THEN
      RETURN occurrence_date + (frequency_value || ' weeks')::INTERVAL;
    WHEN 'monthly' THEN
      RETURN occurrence_date + (frequency_value || ' months')::INTERVAL;
    WHEN 'yearly' THEN
      RETURN occurrence_date + (frequency_value || ' years')::INTERVAL;
    ELSE
